...
for iter = 1:niter
    ...
    tupdate = transfUpdate_2d_parallel_mex(t0, nnIDXs, Xlatent, Y, sigma, alpha, rho, coord, K, b, nnDict, logsig, Sig, Cov_NN, incre, nsubj, bnds,  parworkers);
    ...
    rho = RhoUpdate_2d_parallel_mex(Xlatent,XTs, rho, coord, nnIDXs, nsubj, K, alpha, [0,2], 5e-3, Cov_NN, muFsX, nnX, parworkers);
    rhoMat(iter) = rho.rho;
