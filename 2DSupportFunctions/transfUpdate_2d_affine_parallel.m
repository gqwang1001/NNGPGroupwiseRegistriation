function out = transfUpdate_2d_affine_parallel(transf0, DTs, nnIDXs,...
    X, Y, sigma, alpha, rho, coord,K, b, nnDict, logsig, Sig, ...
...
if jointUpdate == true
    ...
    parfor (i = 1:nsubj, parworkers)
        ...
        Tmat_prop = expm(Vec2Mat(prop0, true))*Vec2Mat(t1(i,:), false);
...
out = mvtpdf(centered(:), ta0/tb0*S, 2*ta0);
