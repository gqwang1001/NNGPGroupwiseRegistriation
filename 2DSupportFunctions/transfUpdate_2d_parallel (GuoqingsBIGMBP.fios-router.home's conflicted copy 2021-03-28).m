function out = transfUpdate_2d_parallel(transf0, nnIDXs, X, Y, sigma, alpha, rho, coord,K, b, nnDict, logsig, Sig, Cov_NN0, incre, nsubj, bnds, parworkers)
